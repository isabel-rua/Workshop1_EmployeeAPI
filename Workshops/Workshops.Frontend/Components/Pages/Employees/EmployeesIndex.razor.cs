...
public partial class EmployeesIndex
{
    ...
    private async Task<TableData<Employee>> LoadListAsync(TableState state, CancellationToken _)
    {
    ...
    private async Task DeleteAsync(Employee employee)
    {
        ...
        if (responseHttp.Error)
        {
            if (responseHttp.HttpResponseMessage.StatusCode == HttpStatusCode.NotFound)
                ...
                Snackbar.Add((await responseHttp.GetErrorMessageAsync())!, Severity.Error);
            return;
        }
